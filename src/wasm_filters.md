...
`;
    ...
    const filter_module = {
        ...
        section_0a: [
            ...
            //0x20, 0x01, // get the value 
            0x41, 0x00, 
            0x36, 0x02, 0x00, // store (paint)
            //0x28, 0x20, 0x00, // i32.load the value
            //0x21, 0x01, // save the value to the second local
            0x20, 0x00, // local.get address
            0x41, 0xff, // i32.const 65532 = 0x10000 - 4 
