...
### In the sense of source code
This page and all the code it runs are in one page. You can view [the source code](https://github.com/ontouchstart/cloudflare-page/blob/master/src/onepage.md).

### In the sense of WASM memory (1 page = 64KBi)
